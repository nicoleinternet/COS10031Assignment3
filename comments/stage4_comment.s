...
queryloop:
    ...
    ;; We can only have a MAX of 8bit int for currentGuessCounts here (128)
    MOV R3, #0
    LDRB R3, currentGuessCount
    ;; Increment guess count by 1
    ADD R3, R3, #1
    ;; STORE THE VALUE BACK INTO CURRENTGUESSCOUNT, WE WIPE R3 AFTER
    STRB R3, currentGuessCount
    ;; Check if we are at guess limit (Branch if Greater Than)
    CMP R3, R11
    BGT break
    ;; reset R3
    MOV R3, #0
    ...
    ;; Print 'What is your guess' by storing message label address and printing to .WriteString
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    STR R10, .WriteString
    ;; Print guess number by loading currentGuessCount;;
    ;;;;;;;;;;UNSIGNED NUM BEING WRITTEN;;;;;;;;;;;;;;;;
    ...
    STR R10, .WriteString
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ;; Get codebreaker's guess - Stage 2 ;;;;
    BL getcode
    ;;;;RETURN WITH CODE, BRANCH TO PUT QUERYCODE (NOW SANITISED) IN ARRAY;;;;
    BL queryCodeToArray
    ;;;;;;;;;;QUERY TIME STAGE 5;;;;;;;;;;;;
    B query
;; out of guesses
