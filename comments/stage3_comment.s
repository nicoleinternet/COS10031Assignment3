...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;STAGE 3 - CODE ENTRY;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Stage 3 - A Code Entry Function - Vandy Aum
;; Marcus - Consolidated into functions and split stage 2 and 3
;; Display request for secret code entry
;; MOV address of prompts into R10, then store address into .WriteString
;; This gives prompts to the user to enter their codes.
    ...
    STR R10, .WriteString
    ;; Branch to getcode in order, and return with code.
    BL getcode
    ;; Branch to store code to array.
    BL secretCodeToArray
;;================================================================================================
;; continue stage 4 code from here
    BL outSecretCode
    HALT
;;================================================================================================
;; FUNCTIONS
...
;;
codeArraySize: 16 ;; 4 elements * 4 bytes
.ALIGN 128
secretcode: .BYTE   0
                    0
                    0
